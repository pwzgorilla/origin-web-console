...
localStorage.setItem(Le, e), Ee(), Ne = "app" === A.viewBy ? [ "metadata.name", "metadata.labels.app" ] : [ "metadata.name" ], Be(), "pipeline" === A.viewBy ? b.setLabelSuggestions(fe) : b.setLabelSuggestions(ge);
...
var t = Se(e);
return t ? Ve(e) ? [ e ] : _.get(A, [ "state", "podsByOwnerUID", t ], []) : [];
}, xe = function(e, t) {
var n = Se(e);
...
if (Se(e)) {
var t = Oe(e), n = R.getPodAlerts(t, a.project);
xe(e, n);
}
}, Me = function(e) {
_.each(e, Fe);
...
return "Succeeded" !== e.status.phase && "Failed" !== e.status.phase && (!z(e, "openshift.io/deployer-pod-for.name") && (!V(e, "openshift.io/build.name") && "slave" !== z(e, "jenkins")));
}, tt = function() {
he.podsByOwnerUID = j.groupByOwnerUID(A.pods), A.monopods = _.filter(he.podsByOwnerUID[""], et);
}, nt = function(e) {
return !!_.get(e, "status.replicas") || (!V(e, "deploymentConfig") || U(e));
}, rt = function(e) {
return V(e, "deploymentConfig");
}, at = function() {
...
o && !q(r, o) || (ve[a] = r);
var i;
"Complete" === V(r, "deploymentStatus") && ((i = t[a]) && !q(r, i) || (t[a] = r)), nt(r) && _.set(n, [ a, r.metadata.name ], r);
...
var e = E.groupByService(A.routes, !0);
he.routesByService = _.mapValues(e, E.sortRoutesByScore), ke();
}, dt = function() {
he.hpaByResource = f.groupHPAs(A.horizontalPodAutoscalers);
}, mt = function(e) {
var t = x(e), n = A.buildConfigs[t];
if (n) {
...
}), A.pipelineBuildConfigs = _.sortBy(e, "metadata.name"), Re(), Xe(A.pipelineBuildConfigs), Ee();
}, bt = function() {
...
var o, i, s = {}, c = {};
u.SERVICE_CATALOG_ENABLED && O(se, "watch") && (o = function(e) {
...
poll: B,
pollInterval: 6e4
}))), u.SERVICE_CATALOG_ENABLED && O(oe, "watch") && kt.push(m.watch(oe, r, function(e) {
...
} ]), angular.module("openshiftConsole").factory("RoutesService", [ "$filter", "gettext", "gettextCatalog", function(e, t, n) {
var r = function(e) {
return angular.isString(e);
}, a = function(e, t) {
return _.find(t.spec.ports, function(t) {
return r(e) ? t.name === e : t.targetPort === e;
});
}, o = function(e, o, i, s) {
if ("Service" === o.kind) {
var c = _.get(i, [ o.name ]);
if (c) {
var l = e.spec.port ? e.spec.port.targetPort : null;
l ? a(l, c) || (r(l) ? s.push(n.getString(t('Route target port is set to "')) + l + n.getString(t('", but service "')) + c.metadata.name + n.getString(t('" has no port with that name.'))) : s.push(n.getString(t('Route target port is set to "')) + l + n.getString(t('", but service "')) + c.metadata.name + n.getString(t('" does not expose that port.')))) : _.size(c.spec.ports) > 1 && s.push('Route has no target port, but service "' + c.metadata.name + '" has multiple ports. The route will round robin traffic across all exposed ports on the service.');
} else s.push('Routes to service "' + o.name + '", but service does not exist.');
}
}, i = function(e, t) {
...
}, l = e("annotation"), u = function(e) {
return "true" !== l(e, "openshift.io/host.generated");
}, d = function(e) {
var t = 0;
c(e) && (t += 11);
var n = _.get(e, "spec.alternateBackends");
return _.isEmpty(n) || (t += 5), u(e) && (t += 3), e.spec.tls && (t += 1), t;
}, m = function(e) {
var t = {}, n = function(e, n) {
t[n] = t[n] || [], t[n].push(e);
};
...
var n = [];
return e ? (o(e, e.spec.to, t, n), _.each(e.spec.alternateBackends, function(r) {
o(e, r, t, n);
}), i(e, n), s(e, n), n) : n;
},
getServicePortForRoute: a,
getPreferredDisplayRoute: function(e, t) {
var n = d(e);
return d(t) > n ? t : e;
},
groupByService: function(e, t) {
return t ? m(e) : _.groupBy(e, "spec.to.name");
},
...
n.limitRanges = _.sortBy(e.by("metadata.name"), "metadata.name"), n.emptyMessageLimitRanges = s("There are no limit ranges set on this project."), angular.forEach(n.limitRanges, function(e) {
...
} ]), angular.module("openshiftConsole").controller("MonitoringController", [ "$routeParams", "$location", "$scope", "$filter", "BuildsService", "DataService", "ImageStreamResolver", "KeywordService", "Logger", "MetricsService", "Navigate", "PodsService", "ProjectsService", "$rootScope", "gettext", function(e, t, n, r, a, o, i, s, c, l, u, d, m, p, g) {
...
n.filteredPods = s.filterForKeywords(C, P, j), n.filteredReplicationControllers = s.filterForKeywords(b, P, j), n.filteredReplicaSets = s.filterForKeywords(S, P, j), n.filteredBuilds = s.filterForKeywords(y, P, j), n.filteredStatefulSets = s.filterForKeywords(_.values(n.statefulSets), P, j);
}, I = function(e) {
...
n.filteredStatefulSets = s.filterForKeywords(_.values(n.statefulSets), P, j);
}, N = function() {
C = _.filter(n.pods, function(e) {
return !n.filters.hideOlderResources || "Succeeded" !== e.status.phase && "Failed" !== e.status.phase;
}), n.filteredPods = s.filterForKeywords(C, P, j);
...
}), n.filteredBuilds = s.filterForKeywords(y, P, j);
}, V = r("deploymentStatus"), O = r("deploymentIsInProgress"), x = function() {
b = _.filter(n.replicationControllers, function(e) {
return !n.filters.hideOlderResources || (O(e) || "Active" === V(e));
}), n.filteredReplicationControllers = s.filterForKeywords(b, P, j);
}, U = function() {
S = _.filter(n.replicaSets, function(e) {
return !n.filters.hideOlderResources || _.get(e, "status.replicas");
}), n.filteredReplicaSets = s.filterForKeywords(S, P, j);
};
...
n.project = e, n.projectContext = r, v.push(o.watch("pods", r, function(e) {
n.podsByName = e.by("metadata.name"), n.pods = w(n.podsByName, !0), n.podsByOwnerUID = d.groupByOwnerUID(n.pods), n.podsLoaded = !0, _.each(n.pods, I), N(), c.log("pods", n.pods);
})), v.push(o.watch({
resource: "statefulsets",
group: "apps",
version: "v1beta1"
...
poll: f,
pollInterval: 6e4
})), v.push(o.watch("replicationcontrollers", r, function(e) {
n.replicationControllers = w(e.by("metadata.name"), !0), n.replicationControllersLoaded = !0, _.each(n.replicationControllers, R), x(), c.log("replicationcontrollers", n.replicationControllers);
})), v.push(o.watch("builds", r, function(e) {
n.builds = w(e.by("metadata.name"), !0), n.latestBuildByConfig = a.latestBuildByConfig(n.builds), n.buildsLoaded = !0, _.each(n.builds, E), L(), c.log("builds", n.builds);
})), v.push(o.watch({
group: "extensions",
resource: "replicasets"
}, r, function(e) {
n.replicaSets = w(e.by("metadata.name"), !0), n.replicaSetsLoaded = !0, U(), c.log("replicasets", n.replicaSets);
}, {
poll: f,
pollInterval: 6e4
})), n.$on("$destroy", function() {
...
n.filterKeywords = j = s.generateKeywords(n.filters.text), n.$apply(k);
}, 50, {
maxWait: 250
...
E(), k("success", j.update.subject.success({
roleName: t.metadata.name,
subjectName: n.name
}));
}, function(r) {
I(), E(), k("error", j.update.subject.error({
roleName: t.metadata.name,
subjectName: n.name
}), e("getErrorDetails")(r));
});
...
switch (d) {
case "ReplicaSet":
e.resource = T, e.healthCheckURL = f.healthCheckURL(n.project, "ReplicaSet", n.replicaSet, "extensions");
break;

case "ReplicationController":
e.resource = N, e.healthCheckURL = f.healthCheckURL(n.project, "ReplicationController", n.replicaSet);
}
var $ = {};
...
e.deployment = t, e.healthCheckURL = f.healthCheckURL(n.project, "Deployment", t.metadata.name, "apps"), B.push(i.watchObject(e.deploymentsVersion, t.metadata.name, u, function(t, r) {
...
}), e.replicaSet = t, V(t), x(), H(), e.deployment && F();
...
var p, g = [], f = [], v = t("serviceInstanceDisplayName"), h = t("isServiceInstanceReady"), y = function() {
e.breadcrumbs.push({
title: e.displayName
});
}, b = function() {
...
!e.serviceInstance || e.serviceClass || p || (p = d.fetchServiceClassForInstance(e.serviceInstance).then(function(t) {
e.serviceClass = t, e.displayName = v(e.serviceInstance, e.serviceClass), y(), p = null, i.getServicePlans().then(function(t) {
...
P(t), g.push(s.watchObject(e.serviceInstancesVersion, n.instance, o, P)), g.push(s.watch(m, o, function(n) {
var r = n.by("metadata.name");
...
} ]), angular.module("openshiftConsole").controller("EditDeploymentConfigController", [ "$scope", "$filter", "$location", "$routeParams", "$uibModal", "$window", "APIService", "AuthorizationService", "BreadcrumbsService", "DataService", "EnvironmentService", "Navigate", "NotificationsService", "ProjectsService", "SecretsService", "keyValueEditorUtils", function(e, t, n, r, a, o, i, s, c, l, u, d, m, p, g, f) {
...
}), _.has(e, "strategyData.customParams.environment") && (e.strategyData.customParams.environment = f.compactEntries(e.strategyData.customParams.environment)), e.updatedDeploymentConfig.spec.template.spec.imagePullSecrets = _.filter(e.secrets.pullSecrets, "name"), e.updatedDeploymentConfig.spec.strategy = e.strategyData, e.updatedDeploymentConfig.spec.triggers = T(), N(), l.update(b, e.updatedDeploymentConfig.metadata.name, e.updatedDeploymentConfig, e.context).then(function() {
m.addNotification({
type: "success",
...
p();
}, g.push(c.watchObject(s, e.name, a, function(t, n) {
...
name: "app",
value: ""
}, T = t("orderByDisplayName"), N = t("getErrorDetails"), D = {}, A = function() {
...
e.$on("$destroy", A);
var $ = i.getPreferredVersion("configmaps"), B = i.getPreferredVersion("limitranges"), L = i.getPreferredVersion("imagestreams"), V = i.getPreferredVersion("imagestreamtags"), O = i.getPreferredVersion("secrets"), x = i.getPreferredVersion("resourcequotas"), U = i.getPreferredVersion("appliedclusterresourcequotas");
...
include: !0,
portOptions: []
}, r.labelArray = [ E ], r.annotations = {}, r.scaling = {
replicas: 1,
autoscale: !1,
autoscaleOptions: [ {
label: "Manual",
...
}, g = a.getPreferredVersion("imagestreams"), f = a.getPreferredVersion("imagestreamtags"), v = a.getPreferredVersion("templates"), h = window.OPENSHIFT_CONSTANTS.CREATE_FROM_URL_WHITELIST, y = [ "namespace", "name", "imageStream", "imageTag", "sourceURI", "sourceRef", "contextDir", "template", "templateParamsMap" ], b = _.pickBy(t, function(e, t) {
...
var R = e("humanizeKind"), E = e("getErrorDetails");
...
}), f.disableInputs = !1) : N.length ? (T(N), f.disableInputs = !1) : S();
}, $ = function() {
...
if (e.href) return u.nav.showMobileNav = !1, void (u.sidebar.secondaryOpen = !1);
p(), e.isHover = !0, e.mobileSecondary = u.isMobile, u.sidebar.showMobileSecondary = u.isMobile, u.sidebar.secondaryOpen = !0;
...
e.isHover = !0, e.mouseEnterTimeout = null, u.sidebar.secondaryOpen = !0;
}, 300));
...
} ]).directive("oscHeader", [ "$filter", "$location", "$q", "$rootScope", "$routeParams", "$timeout", "APIService", "AuthorizationService", "Catalog", "CatalogService", "Constants", "DataService", "Navigate", "NotificationsService", "ProjectsService", "projectOverviewURLFilter", "RecentlyViewedServiceItems", function(e, t, n, r, a, o, i, s, c, l, u, d, m, p, g, f, v) {
...
E[t.id] ? E[t.id].load(a) : ((n = L(e)).data = a, r(function() {
...
T[o] ? T[o].load(a) : ((n = V(e)).data = a, e.chartDataColors && (n.color = {
...
var R, E = {}, T = {}, N = n("resources.limits.memory"), D = n("resources.limits.cpu"), A = 30, $ = !1;
...
var x = o.$on("metrics.charts.resize", function() {
c.redraw(E), c.redraw(T);
});
p.$on("$destroy", function() {
R && (t.cancel(R), R = null), x && (x(), x = null), angular.forEach(E, function(e) {
e.destroy();
...
t.$evalAsync(function() {
t.empty = !1, "logs" !== t.state && (t.state = "logs", E());
...
return _.some(a, {
severity: "error"
}) ? "Error" : _.isEmpty(a) ? t(e) ? "Pulling" : "Running" !== e.status.phase || u(e) ? _.get(e, "status.phase", "Unknown") : "Not Ready" : "Warning";
}
...
b.disableInputs = !0, E().then(function(e) {
...
controller: [ "$scope", "$filter", "$routeParams", "Catalog", "DataService", "KeywordService", "NotificationsService", "ProjectsService", "RecentlyViewedProjectsService", function(e, t, n, r, a, o, i, s, c, l) {
function u() {
...
function m() {
C.steps || (C.steps = [ C.selectStep, C.infoStep, C.configStep, C.resultsStep ]);
}
function p() {
S && (S(), S = void 0);
}
...
function v(e) {
C.filterConfig.appliedFilters = e, h();
}
function h() {
C.filteredItems = C.catalogItems, C.filterConfig.appliedFilters && C.filterConfig.appliedFilters.length > 0 && _.each(C.filterConfig.appliedFilters, function(e) {
C.filteredItems = f(e.value, C.filteredItems);
}), _.includes(C.filteredItems, C.selectedTemplate) || C.templateSelected(), y();
}
function y() {
C.filterConfig.resultsCount = C.filteredItems.length, C.totalCount <= 1 ? $(".filter-pf.filter-fields input").attr("disabled", "") : $(".filter-pf.filter-fields input").removeAttr("disabled");
}
function b() {
C.unfilteredProjects || s.list().then(function(e) {
C.unfilteredProjects = _.toArray(e.by("metadata.name"));
}, function() {
C.unfilteredProjects = [];
}).finally(function() {
P();
});
}
var S, C = this, w = t("imageForIconClass");
C.selectStep = {
id: "projectTemplates",
label: "Selection",
view: "views/directives/process-template-dialog/process-template-select.html",
hidden: !0 !== C.useProjectTemplate,
allowed: !0,
valid: !1,
allowClickNav: !0,
onShow: function() {
C.infoStep.selected = !1, C.selectStep.selected = !0, C.configStep.selected = !1, C.resultsStep.selected = !1, C.nextTitle = "Next >", p(), b();
}
}, C.infoStep = {
id: "info",
label: "Information",
...
allowClickNav: !0,
onShow: function() {
C.infoStep.selected = !0, C.selectStep.selected = !1, C.configStep.selected = !1, C.resultsStep.selected = !1, C.nextTitle = "Next >", p();
}
}, C.configStep = {
id: "configuration",
label: "Configuration",
...
allowClickNav: !0,
onShow: function() {
C.infoStep.selected = !1, C.selectStep.selected = !1, C.configStep.selected = !0, C.resultsStep.selected = !1, C.nextTitle = "Create", C.resultsStep.allowed = C.configStep.valid, S = e.$watch("$ctrl.form.$valid", function(e) {
C.configStep.valid = e && !C.noProjectsCantCreate && C.selectedProject, C.resultsStep.allowed = e;
});
}
}, C.resultsStep = {
id: "results",
...
allowClickNav: !1,
onShow: function() {
C.infoStep.selected = !1, C.selectStep.selected = !1, C.configStep.selected = !1, C.resultsStep.selected = !0, C.nextTitle = "Close", p(), C.wizardDone = !0;
}
}, C.$onInit = function() {
C.loginBaseUrl = a.openshiftAPIBaseUrl(), C.preSelectedProject = C.selectedProject = C.project, C.useProjectTemplate && (C.project && (C.templateProject = C.project, C.templateProjectChange()), b()), C.noProjectsCantCreate = !1, e.$on("no-projects-cannot-create", function() {
...
appliedFilters: [],
onFilterChange: v
}, n.project || (C.showProjectName = !0);
}, C.$onChanges = function(e) {
e.template && C.template && (m(), C.iconClass = u(), C.image = d(), C.docUrl = c(C.template, "template.openshift.io/documentation-url"), C.supportUrl = c(C.template, "template.openshift.io/support-url"), C.vendor = c(C.template, "template.openshift.io/provider-display-name")), e.useProjectTemplate && m();
}, e.$on("templateInstantiated", function(e, t) {
C.selectedProject = t.project, C.currentStep = C.resultsStep.label;
}), C.$onDestroy = function() {
p();
}, C.next = function(e) {
return e.stepId === C.configStep.id ? (g(), !1) : e.stepId !== C.resultsStep.id || (C.close(), !1);
}, C.close = function() {
var e = C.onDialogClosed();
_.isFunction(e) && e();
}, C.onProjectSelected = function(t) {
C.selectedProject = t, C.configStep.valid = e.$ctrl.form.$valid && C.selectedProject;
}, C.templateSelected = function(e) {
C.selectedTemplate = e, C.template = _.get(e, "resource"), C.selectStep.valid = !!e, C.iconClass = u(), C.image = d(), C.docUrl = c(C.template, "template.openshift.io/documentation-url"), C.supportUrl = c(C.template, "template.openshift.io/support-url"), C.vendor = c(C.template, "template.openshift.io/provider-display-name");
}, C.templateProjectChange = function() {
C.templateProjectName = _.get(C.templateProject, "metadata.name"), C.catalogItems = {}, C.templateSelected(), r.getProjectCatalogItems(C.templateProjectName, !1, !0).then(_.spread(function(e, t) {
C.catalogItems = e, C.totalCount = C.catalogItems.length, h(), t && i.addNotification({
type: "error",
message: t
});
}));
...
var P = function() {
var e = _.reject(C.unfilteredProjects, "metadata.deletionTimestamp"), n = _.sortBy(e, t("displayName"));
C.searchEnabled = !_.isEmpty(e), C.templateProjects = l.orderByMostRecentlyViewed(n);
};
} ],
controllerAs: "$ctrl",
bindings: {
...
} ]), angular.module("openshiftConsole").directive("deployImage", [ "$filter", "$q", "$window", "$uibModal", "APIService", "ApplicationGenerator", "DataService", "ImagesService", "Navigate", "NotificationsService", "ProjectsService", "QuotaService", "TaskList", "SecretsService", "keyValueEditorUtils", function(e, t, n, r, a, o, i, s, c, l, u, d, m, p, g) {
var f = a.getPreferredVersion("imagestreamimages"), v = a.getPreferredVersion("configmaps"), h = a.getPreferredVersion("secrets");
return {
restrict: "E",
scope: {
project: "=",
...
tag: t.tagObject.tag,
namespace: t.namespace
}, c && (a = t.imageStream + "@" + c, n.loading = !0, i.get(f, a, {
namespace: t.namespace
}).then(function(e) {
...
var d, m, p = s.getPreferredVersion("events"), g = s.getPreferredVersion("projects"), f = _.get(c, "DISABLE_GLOBAL_EVENT_WATCH"), v = e("isIE")(), h = this, y = [], b = {}, S = {}, C = {}, w = function(e) {
e || (h.drawerHidden = !0);
}, P = function(e, t) {
return _.get(e, "params.project") !== _.get(t, "params.project");
}, j = function(e) {
...
x(), d = r.$on("NotificationsService.onNotificationAdded", t);
}), z = function() {
j(a.project).then(function() {
M(a.project, U), q(a.project, F), w(a.project), L();
});
};
angular.extend(h, {
drawerHidden: !0,
