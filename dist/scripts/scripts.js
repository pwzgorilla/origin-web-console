...
} ]), angular.module("openshiftConsole").factory("OctopusService", [ "$filter", "ApplicationGenerator", "DataService", function(a, b, c) {
var d = function(a) {
var b = {
apiVersion:"v1",
kind:"Service",
...
value:a.SPRING_DATASOURCE_JDBC
}, {
...
return {
findServiceV1:d,
findDeploymentConfigV1:e,
findServiceV2:f,
findDeploymentConfigV2:g
};
...
} ]), angular.module("openshiftConsole").directive("openShift", [ "$resource", "$q", "$filter", "QuotaService", "ApplicationGenerator", "SecurityCheckService", "NotificationsService", "$routeParams", "DataService", "TaskList", "Navigate", "$window", "OctopusService", function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
return {
restrict:"E",
scope:{
project:"=",
...
link:function(d) {
function e(b) {
return a(o + "://" + p + "/v1/namespaces/:namespace/services", {
namespace:q
}, {
get:{
headers:{
...
e().get(function(a) {
var b = [];
d.inOpenShift = a, a.items.forEach(function(a, c) {
b.push(a.metadata.name);
}), d.octopuses = b.sort();
});
}
d.octopuses = [], d.app = {
...
var n = {}, o = "http:" === l.location.protocol ? "http" :"https", p = l.OPENSHIFT_CONFIG.api.k8s.hostPort + l.OPENSHIFT_CONFIG.api.k8s.prefix, q = (l.OPENSHIFT_CONFIG.api.openshift.hostPort + l.OPENSHIFT_CONFIG.api.openshift.prefix, h.project), r = "Bearer", s = r + " " + localStorage.getItem("LocalStorageUserStore.token"), t = (c("humanize"), []);
f();
var u = c("displayName"), v = c("humanizeKind"), w = function() {
var a = {
started:"Deploying image " + d.app.APP_NAME + " to project " + u(d.project),
success:"Deployed image " + d.app.APP_NAME + " to project " + u(d.project),
failure:"Failed to deploy image " + d.app.APP_NAME + " to project " + u(d.project)
};
j.clear(), j.add(a, {}, d.project.metadata.APP_NAME, function() {
var a = b.defer();
return i.batch(t, d.context).then(function(b) {
var c, e = !_.isEmpty(b.failure);
e ? (c = _.map(b.failure, function(a) {
return {
type:"error",
message:"Cannot create " + v(a.object.kind).toLowerCase() + ' "' + a.object.metadata.name + '". ',
details:a.data.message
};
}), c = c.concat(_.map(b.success, function(a) {
return {
type:"success",
...
type:"success",
message:"All resources for image " + d.app.name + " were created successfully."
} ], a.resolve({
alerts:c,
hasErrors:e
});
}), a.promise;
}), k.toNextSteps(d.app.APP_NAME, d.project.metadata.name);
}, x = {}, y = function() {
g.hideNotification("deploy-image-list-config-maps-error"), g.hideNotification("deploy-image-list-secrets-error"), _.each(x, function(a) {
!a.id || "error" !== a.type && "warning" !== a.type || g.hideNotification(a.id);
});
};
d.create = function() {
y(), n = {
APP_NAME:d.app.APP_NAME,
OCTOPUS_API_NAME:d.app.OCTOPUS_API_NAME,
NAMESPACE:q,
K8S_URI:d.app.K8S_URI,
REGISTRY_URI:d.app.REGISTRY_URI,
SECRET_NAME:d.app.SECRET_NAME,
SECRET_KEY:d.app.SECRET_KEY,
SPRING_DATASOURCE_JDBC:d.app.SPRING_DATASOURCE_JDBC,
OCTOPUS_CONSOLE_NAME:d.app.OCTOPUS_CONSOLE_NAME
};
var a = m.findServiceV1(n), b = m.findDeploymentConfigV1(n), c = m.findServiceV2(n), e = m.findDeploymentConfigV2(n);
t = [ a, b, c, e ], w();
};
}
};
...
function l(a) {
angular.forEach(a, function(a) {
"K8S_NAMESPACE" !== a.name && (p.appParams[a.name] = a);
});
}
function m(a) {
angular.forEach(a, function(a) {
"K8S_NAMESPACE" === a.name && (a.value = p.selectedProject.metadata.name);
});
}
var n, o, p = this, q = a("displayName"), r = a("humanize");
p.appParams = {}, p.$onInit = function() {
p.labels = [], p.template = i.squidTemplate(), p.templateDisplayName = q(p.template), p.selectedProject = p.project, l(p.template.parameters);
};
var s = function() {
var a = {
started:"Creating " + p.templateDisplayName + " in project " + q(p.selectedProject),
...
k(p.template);
j.clear(), j.add(a, p.template, p.selectedProject.metadata.name, function() {
var a = b.defer();
return e.batch(o, n).then(function(b) {
var c = [], d = !1;
b.failure.length > 0 ? (d = !0, b.failure.forEach(function(a) {
c.push({
type:"error",
...
g.hideNotification("process-template-error"), _.each(t, function(a) {
!a.id || "error" !== a.type && "warning" !== a.type || g.hideNotification(a.id);
});
}, v = function(a) {
u(), s();
};
p.createFromSquid = function() {
m(p.template.parameters), n = {
namespace:p.selectedProject.metadata.name
}, e.create("processedtemplates", null, p.template, n).then(function(a) {
console.log("config", a), h.setTemplateData(a.parameters, p.template.parameters, a.message), o = a.objects, v();
}, function(a) {
p.disableInputs = !1;
var b;
a.data && a.data.message && (b = a.data.message), g.addNotification({
...
u(), f.toProjectOverview(p.project.metadata.name);
};
}
angular.module("openshiftConsole").component("openSquid", {
controller:[ "$filter", "$q", "$scope", "$uibModal", "DataService", "Navigate", "NotificationsService", "ProcessedTemplateService", "SquidService", "TaskList", a ],
controllerAs:"$ctrl",
bindings:{
template:"<",
project:"<",
